...
function updateCurrency(e) {
    const selectedOption = e.target.closest('.select').querySelector('.val');
...
function getCurrencyVal() {
    let currency1 = selects[0].querySelector('.val').textContent.toUpperCase();
    let currency2 = selects[1].querySelector('.val').textContent.toUpperCase();
